...
# Пути для проверки analyzer.py. ОБЯЗАТЕЛЬНО здесь указать.Иначе не будет работать весь проект.
...
VENV_NAME="smart_home_climate" # Имя виртуального окружения
# Пути для проверки базы данных
DATA_DIR="/home/andrey/andrey_folder/Indoor_climate/smart_home_climate"  
